...
ResponseProcessor = Callable[[aiohttp.ClientResponse], Coroutine[Any, Any, ProcessedResponse]]


async def simple_json_processor(response: aiohttp.ClientResponse) -> ProcessedResponse:
